...
RESUME_CHECKPOINT="${RESUME_CHECKPOINT:-/work/vajira/DL2026/ECGEN-VAE/vae_baseline/runs/vae_baseline_mimic/seed_42/checkpoints/last.ckpt}"
...
WANDB_PROJECT="${WANDB_PROJECT:-ecg-vae}"
